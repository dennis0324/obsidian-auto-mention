...
Built with TypeScript, esbuild, and React (settings UI). Install dependencies with **Bun** (see below).
...
- Install NodeJS, then run `bun i` in the command line under your repo folder.
...
- `bun i` or `yarn` to install dependencies.
